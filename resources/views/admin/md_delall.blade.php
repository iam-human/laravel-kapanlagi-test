        ...
        <div class="modal-content bg-secondary">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="py-3 text-center">
                    ...
                    <h4 class="heading mt-4">Yakin Data-data ini akan dihapus ? 
                    </h4>
            ...
            <div class="modal-footer">
                @if (isset($data))
                <a href="{{url('del/admin')}}" class="btn btn-danger">Ok, Hapus</a>
                <a href="{{url('admin')}}" class="btn btn-link text-danger ml-auto">Cancel</a>
                @else
